...
<body class="ms-body ms-aside-left-open ms-primary-theme ">
  ...
  ?>
                    <tr>
                      ...
                      <td><span class="badge badge-outline-warning"><?php echo $row['order_status_str'] ?></span></td>
                      <?php } ?>
                      <?php if($row['order_status']==2) {?>
                      <td><span class="badge badge-outline-primary"><?php echo $row['order_status_str'] ?></span></td>
                      <?php } ?>
                      <?php if($row['order_status']==3) {?>
                      <td><span class="badge badge-outline-success"><?php echo $row['order_status_str'] ?></span></td>
                      <?php } ?>
                      <?php if($row['order_status']==4) {?>
                      <td><span class="badge badge-outline-danger"><?php echo $row['order_status_str'] ?></span></td>
                      <?php } ?>
                      

                      <td> <a href="order_detail.php?id=<?php echo $row['id'] ?>" class="ms-text-primary"> View Details</a></td>
