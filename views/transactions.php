...
require_once('../../front/views/paypage/db.php');
require_once('../../front/views/paypage/pdo_db.php');
require_once('../../front/entities/transaction.php');

//instaniate transaction
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="Commande-page" class="collapse" aria-labelledby="Commande-page" data-parent="#side-nav-accordion">
          ...
          <li> <a href="SupprimerCommande.html">Customers</a> </li>
