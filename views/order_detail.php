    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="Commande-page" class="collapse" aria-labelledby="Commande-page" data-parent="#side-nav-accordion">
          ...
          <li> <a href="ModifierCommande.html">Modifier Une commande</a> </li>
          <li> <a href="SupprimerCommande.html">Supprimmer Une commande</a> </li>
          <li> <a href="AfficherCommande.html"> Afficher les commandes</a> </li>
...
<div class="ms-panel">
  ...
  <div class="ms-panel-body">
    <div class="table-responsive">
      <table id="data-table-2" class="table table-striped thead-primary w-100 dataTable no-footer" role="grid" aria-describedby="data-table-2_info" style="width: 1158px;">
      <thead>
        <tr role="row">
        <th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="User Name: activate to sort column ascending" style="width: 166px;">Product Name</th>
        <th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="User Name: activate to sort column ascending" style="width: 166px;">Product Image</th>
        <th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Email Id: activate to sort column ascending" style="width: 166px;">Qty</th>
        <th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Order Id: activate to sort column ascending" style="width: 166px;">Price</th>
        <th class="sorting" tabindex="0" aria-controls="data-table-2" rowspan="1" colspan="1" aria-label="Product Name: activate to sort column ascending" style="width: 166px;">Total Price</th>
      </tr>
    </thead>
    <?php 
    $order_id=$_GET['id'];
    $conn = mysqli_connect("localhost","root","","shop");
    $res=mysqli_query($conn,"select distinct(order_detail.id),order_detail.*,products.name from order_detail,products,`order` where order_detail.order_id='$order_id' and order_detail.product_id=products.id");
    while($row=mysqli_fetch_assoc($res)){
  ?>
        <tr role="row" class="odd">
        <td class="sorting_1"><?php echo $row['name'] ?></td>
        <td> <img src="../../front/views/products-images/<?= $row['product_id'] ?>.png" alt="" ></td>
...
<?php 
    $order_id=$_GET['id'];
$conn = mysqli_connect("localhost","root","","sefrim");
    $res=mysqli_query($conn,"select * from `order` where `order`.id='$order_id'");
    while($row=mysqli_fetch_assoc($res)){
...
<tr>
   ...
   <td><h6><?php echo $row['total_price'] ?> DT</h6></td>
   </tr>
    </table>
    <strong>Addres</strong> 
    <?php echo $row['address'] ?> , <?php echo $row['city'] ?> , <?php echo $row['pincode'] ?> <br><br>
    <strong>Order Status</strong> 
    <?php $order_status_arr=mysqli_fetch_assoc(mysqli_query($conn,"select order_status.name from order_status where id='$order_status'"));
