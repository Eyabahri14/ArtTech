    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        <a href="#" class="has-chevron" data-toggle="collapse" data-target="#Panier-page" aria-expanded="false" aria-controls="Panier-page">
          <span><i class='fas fa-shopping-cart' style='font-size:18px;color:white'></i>Gestion De commande</span>
        </a>
        <ul id="Panier-page" class="collapse" aria-labelledby="Panier-page" data-parent="#side-nav-accordion">
          <li> <a href="customers.php">Customers</a> </li>
          <li> <a href="AfficherCommande2.php"> Afficher les commandes</a> </li>
     ...
     <!-- /gestion des livraisons/livreurs-->
      ...
      <li class="menu-item">
        ...
        <ul id="Reclamation-page" class="collapse" aria-labelledby="Reclamation-page" data-parent="#side-nav-accordion">
          <li> <a href="Sefrim_back_anas/pages/Reclamation/AjoutReclamation.html">Ajouter Une réclamation</a> </li>
          <li> <a href="Sefrim_back_anas/pages/Reclamation/ModifierReclamation.html">Modifier Une réclamation</a> </li>
          <li> <a href="Sefrim_back_anas/pages/Reclamation/SupprimerReclamation.html">Supprimmer Une réclamation</a> </li>
          <li> <a href="Sefrim_back_anas/pages/Reclamation/AfficherReclamation.php"> Afficher les réclamations</a> </li>
      ...
      <li class="menu-item">
        ...
        <ul id="Notification-page" class="collapse" aria-labelledby="Notification-page" data-parent="#side-nav-accordion">
          <li> <a href="Sefrim_back_anas/pages/Notification/AjoutNotification.html">Ajouter Une Notification</a> </li>
          <li> <a href="Sefrim_back_anas/pages/Notification/ModifierNotification.html">Modifier Une Notification</a> </li>
          <li> <a href="Sefrim_back_anas/pages/Notification/SupprimerNotification.html">SupprimmerUne Notification</a> </li>
          <li> <a href="Sefrim_back_anas/pages/Notification/AfficherNotification.php"> Afficher les Notifications</a> </li>
      ...
      <li class="menu-item">
        ...
        <ul id="Publicité-page" class="collapse" aria-labelledby="Publicité-page" data-parent="#side-nav-accordion">
          <li> <a href="Sefrim_back_hsan/pages/Publicité/AjoutPublicite.html">Ajouter Une Publicité</a> </li>
          <li> <a href="Sefrim_back_hsan/pages/Publicité/ModifierPublicite.html">Modifier Une Publicité</a> </li>
          <li> <a href="Sefrim_back_hsan/pages/Publicité/SupprimmerPublicite.html">Supprimmer Une Publicité</a> </li>
          <li> <a href="Sefrim_back_hsan/pages/Publicité/AfficherPublicite.html"> Afficher les Publicités</a> </li>
