...
if (isset($_POST['submit'])) {
 if($_POST["name"]==""){
   $name_error="veuillez entrer le name";
 }else if($_POST["teacher"]==""){
     $teachererr="veuillez entrer le teacher";
 }else if($_FILES["image"]["name"]==""){
     $image_error="veuillez selectionner une image";
 }else {
     upload_image();
     $cour = new cour($_POST["name"],$_POST["category"],$_POST["teacher"],$_POST["seance"],$_FILES["image"]["name"],$_POST["type"]);
     $courC = new CourC();
     $courC->addCour($cour);
...
//$cour = new cour( $_POST["category"], $_POST["teacher"],"" ,"test", $_POST["type"]);
...
<form name="form1"  method="POST" action="addCour.php" enctype="multipart/form-data" >
 <center><legend><h2> Ajouter un cours </strong></h2></legend></center>
         <table id="example1" class="table table-striped">
          ...
          <tr>
            <th> teacher </th>
            <th><input type="text" name="teacher"/>
        ...
        <td><button type="submit" name="submit" value="Ajouter" class="btn btn-danger">Ajouter</button></td>
