...
if (isset($_POST['submit'])) {
    ...
    if(empty ($_POST["duree"])){
        $dureeerr="veuillez entrer la duree";
          
        }else {
            $test++;}

            if(empty ($_POST["link"]) && $_POST["type"] == "online"){
                $linkerr="veuillez entrer le link";
                  
                }else {
                    $test++; }
                    if(empty ($_POST["location"]) && $_POST["type"] == "presenstiel"){
                        $locationerr="veuillez entrer la location";
                          
                        }else {
                            $test++;}
                            if($test==3){
                                $seance = new seance( $_POST["type"], $_POST["date_debut"], $_POST["duree"],$_POST["link"],$_POST["location"]);
                                $seanceC = new seanceC();
                                $seanceC->addSeance($seance);
...
<form name="form1"  method="POST" action="addSeance.php" >
 <center><legend><h2> Ajouter une seance </strong></h2></legend></center>
         <table id="example1" class="table table-striped">
          ...
          <tr>
            <th> date debut </th>
            <th><input type="date" name="date_debut"/>
           </th>
          ...
          <tr>
            <th> duree </th>
            <th><input type="number" name="duree"/>
          ...
          <tr id="link">
            ...
            <p class="text-danger"><?php echo $linkerr; ?></p>
            </th>
          </tr>
          <tr id="location">
            <th> location </th>
            ...
            <p class="text-danger"><?php echo $locationerr; ?></p>
            </th>
          </tr>
